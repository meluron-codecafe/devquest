...
def inject_css(html: str) -> str:
  ...
  @media (max-width: 768px) { #timeline-nav { right: 10px !important; padding: 15px 8px !important; gap: 6px !important; } .timeline-line { height: 15px !important; } .theme-toggle { top: 10px; right: 10px; width: 40px; height: 40px; font-size: 16px; } @media (max-width: 480px) { #timeline-nav { display: none !important; } } }
